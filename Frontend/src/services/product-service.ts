...
class ProductService {
    ...
    public async addProduct(product: ProductModel): Promise<void> {
        ...
        const response = await axios.post<ProductModel>(appConfig.productsUrl, formUtil.toProductFormData(product));
        const dbProduct = response.data;
    ...
    public async updateProduct(product: ProductModel): Promise<void> {
        ...
        // Send product to backend:
        const response = await axios.put<ProductModel>(appConfig.productsUrl + "/" + product.id, formUtil.toProductFormData(product) );
        const dbProduct = response.data;
